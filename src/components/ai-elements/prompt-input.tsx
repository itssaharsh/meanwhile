...
export const PromptInputTextarea = ({
  ...
  return (
    <InputGroupTextarea
      className={cn("field-sizing-content max-h-48 min-h-16 text-[16px]", className)}
      name="message"
...
export const PromptInputSubmit = ({
  ...
  return (
    // Meanwhile: no hard-coded aria-label. COPY.md bans "Submit"; callers pass a visible
    // label as children, which is the accessible name.
    <InputGroupButton
      className={cn(className)}
      onClick={handleClick}
      size={size}
...
// Base UI 1.8 sets hover delays on the trigger, not the root.
